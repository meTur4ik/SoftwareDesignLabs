...
public class UserConstants {
    ...
    public static final String PROFILE_IMAGE_STR = "profile_image";
    public static final String RSS_ADDRESS_STR = "rss_address";
    ...
    public static final String USER_RSS_FILE = "rss.xml";
}
